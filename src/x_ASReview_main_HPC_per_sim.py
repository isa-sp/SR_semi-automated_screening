...
path_results = '/hpc/local/Rocky8/julius_te/ispiero/SR_results' #'/home/julius_te/ispiero/systematicreviews/results' #'/Users/ispiero2/Documents/Research/Results_tmp/' 
...
train_models = [LogisticClassifier(), SVMClassifier()] #[LogisticClassifier(), NaiveBayesClassifier(), SVMClassifier()]

# Define the feature extraction model(s) to be tested
feature_models = [SBERT()] #[Tfidf(), SBERT()] # SBERT() only works with PyCharm
